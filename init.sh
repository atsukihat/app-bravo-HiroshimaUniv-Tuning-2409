...
if [[ $HOSTNAME == app-* ]]; then
	...
	curl -L -o ./.da/restore_data.zip https://github.com/DreamArts/HiroshimaUniv-Tuning-2409/releases/download/restore_data-v1.0.0/restore_data.zip
...
docker login -u pull-key -p ${DOCKER_TOKEN} hirouniv2409.azurecr.io > /dev/null 2>&1
